...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) == 0) {
        ...
        $electric_model->update_device($device_id, $dataDevice);
        $_SESSION['message'] = alert('Device added successfully', 'success');
        redirect('home_electrical_appliances.php');
    }
}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="device_name" id="device_name" class="form-control" placeholder="Device Name" value="<?= $device['device_name'] ?>" <span class="text-danger font-weight-bold"><?= isset($errors['device_name']) ? $errors['device_name'] : '' ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="device_watt">Device Watt</label>
                                            <input type="number" name="device_watt" id="device_watt" class="form-control" placeholder="Device Watt" value="<?= $device['device_watt'] ?>" step="0.01">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="device_status" id="device_status" class="form-control">
                                                <option value="1" <?php if ($device['device_status'] == 1) : ?> selected <?php endif; ?>>Active</option>
                                                <option value="2" <?php if ($device['device_status'] == 2) : ?> selected <?php endif; ?>>Inactive</option>
                                            </select>

...
if ($reward_model->get_reward_by_id($_GET['id'])) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) == 0) {
        ...
        $reward_model->update_reward($_GET['id'], $dataReward);
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="reward_name" id="reward_name" class="form-control" placeholder="Reward Name" value="<?= $reward['reward_name'] ?>">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="number" name="reward_point" id="reward_point" class="form-control" placeholder="Reward Point" value="<?= $reward['reward_point'] ?>">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="datetime-local" name="reward_start_date" id="reward_start_date" class="form-control" placeholder="Reward Start Date" value="<?= $reward['reward_start_date'] ?>">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="datetime-local" name="reward_end_date" id="reward_end_date" class="form-control" placeholder="Reward End Date" value="<?= $reward['reward_end_date'] ?>">
                                ...
                                <div class="form-group col-lg-6 col">
                                    ...
                                    <select name="reward_status" id="reward_status" class="form-control">
                                        <option value="1" <?php if ($reward['reward_status'] == 1) : ?> selected <?php endif; ?>>Active</option>
                                        <option value="2" <?php if ($reward['reward_status'] == 2) : ?> selected <?php endif; ?>>Inactive</option>
                                    </select>
